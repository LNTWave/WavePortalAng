        ...
        function ($timeout,$scope,$rootScope) {
            ...
            $scope.sections = [
...

                {
                    ...
                    title: 'Sites',
                    icon: '&#xE55F;',
                    link: 'restricted.pages.site'
                },
                {
                    id: 3,
                    title: 'Systems',
                    icon: '&#xE886;',
                    link: 'restricted.pages.system'
                },
                {
                    id: 4,
                    title: 'Notifications',
                    icon: '&#xE7F4;',
                    link: 'restricted.pages.notification'
                },
                {
                    id: 5,
                    title: 'Policies',
                    icon: '&#xE2BF;',
                    link: 'restricted.pages.policy'
                },
                {
                    id: 6,
                    title: 'Users',
                    icon: '&#xE7FD;',
                    link: 'restricted.pages.user'
                },
                {
                     id: 7,
                     title: 'Groups',
                     icon: '&#xE7EF;',
                     link: 'restricted.pages.group'
                },
                //{
                //    id: 8,
                //    title: 'Forms',
